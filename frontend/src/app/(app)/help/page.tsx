...
const SECTIONS = [
  { q: "How communication scoring works", a: "SpikeOS combines response timeliness, ownership, follow-through, commitment completion, and communication quality into a single response score. The formula and weights are configurable in Settings / Scoring and computed server-side (see backend/app/intelligence/scoring.py)." },
  ...
  { q: "How exclusions work", a: "Automated messages, newsletters, FYI notes, approved PTO, and delegated coverage are excluded from scoring so metrics reflect a fair picture of communication effort — exclusions are applied before scoring, never after." },
  ...
  { q: "Privacy and security", a: "Access follows the organizational hierarchy and is enforced by the FastAPI backend on every request — an employee cannot fetch another employee's data no matter what the frontend shows." },
];
