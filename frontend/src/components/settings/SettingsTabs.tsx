  ...
  return (
    <div className="mb-6 flex gap-1 border-b border-[var(--color-line)]">
      {TABS.map((t) => {
        ...
        return (
          <Link key={t.path} href={t.path} className={clsx("relative px-3 py-2 text-sm font-medium", isActive ? "text-[var(--color-blue-600)]" : "text-[var(--color-ink-500)] hover:text-[var(--color-ink-900)]")}>
            {t.label}
